...
/*Zadání:
http://phoenix.inf.upol.cz/~krajcap/courses/2021LS/OS1/assignment-01.pdf
*/
...
void main() {
	...
	char png[] = "Five hexing wizard bots jump quickly.";
	if (pangram(&png)) {
		printf("\nAno");
	}
	char* sentences[6];
	sentences[0] = "Quick brown fox jumps over the lazy dog."; /* je pangram */
	sentences[1] = "Quick brown dog jumps over the lazy log."; /* neni pangram */
	sentences[2] = "Five hexing wizard bots jump quickly."; /* je pangram */
	sentences[3] = "Two driven jocks help fax my big quiz."; /* je pangram */
	sentences[4] = "She sells seashells by the seashore"; /* neni pangram */
	sentences[5] = NULL;
	print_pangrams(sentences);
}