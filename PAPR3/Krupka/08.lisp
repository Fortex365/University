...
;; Prvky seznamu jsou páry (event . translation). event je standardní název
;; události (např. ev-change), translation je název zprávy, která se má
;; reálně posílat (např. ev-circle1-change). Obvykle je stejný jako standardní.
...
(defmethod rotate ((shape shape) dx dy)
  (changing shape)
  (do-rotate shape dx dy)
  (change shape))
